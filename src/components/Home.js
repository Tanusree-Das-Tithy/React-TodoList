...
const Home = ()=>{
    ...
    const[updatedTodo, setUpdatedTodo]=useState({id: "", todo: {title: ""}});
    ...
    return(
        <div>
           ...
           />
        <button className="ModalSearch" onClick={handleSearch }>Search</button>
       </div>
          
            <Todos todos={list.length > 0 ? list : todos} onRemove={handleDelete} setUpdatedTodo={setUpdatedTodo} />
